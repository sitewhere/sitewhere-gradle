 ...
 */
class GenerateNativeImage extends DockerBuildImage {
	...
	if (getRegistryCredentials() != null) {
	    System.out.println(String.format("Username is %s", getRegistryCredentials().getUsername()));
	}
    }
}
